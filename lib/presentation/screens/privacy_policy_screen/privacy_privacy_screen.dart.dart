...
class _PrivacyPolicyScreenState extends State<PrivacyPolicyScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WebViewWidget(controller: viewController),
      // body: Padding(
...
<ul>
    ...
    <li>
        <p><strong>Application</strong> refers to ShiftSync, the software program provided by the Company.</p>
    </li>
    <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
            &quot;Our&quot; in this Agreement) refers to ShiftSync.</p>
    </li>
    <li>
...
<ul>
    <li>By email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
            data-cfemail="d4a2bdbab1b1fabfb7b894b3b9b5bdb8fab7bbb9">[email&#160;protected]</a></li>
</ul>
