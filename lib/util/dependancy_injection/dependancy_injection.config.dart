...
import 'package:shiftsync/util/dio_module/dio_module.dart' as _i25;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i20.SignInDataProvider>(() => _i20.SignInDataProvider(
          gh<_i7.Dio>(),
          gh<_i6.CookieManager>(),
        ));
    gh.factory<_i21.AttendenceApiProvider>(() => _i21.AttendenceApiProvider(
          gh<_i7.Dio>(),
          gh<_i6.CookieManager>(),
        ));
    gh.factory<_i22.AttendenceBloc>(
        () => _i22.AttendenceBloc(gh<_i3.AttendenceRepository>()));
    gh.factory<_i23.DashboardBloc>(
        () => _i23.DashboardBloc(gh<_i3.GetDutyRepository>()));
    gh.factory<_i24.DashboardDataProvider>(() => _i24.DashboardDataProvider(
          gh<_i7.Dio>(),
          gh<_i6.CookieManager>(),
        ));
    return this;
